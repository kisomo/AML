...
def answer_five():
    ...
    # Your code here
    clf = DecisionTreeClassifier(max_depth = 20, min_samples_leaf = 20, random_state = 0).fit(X_train2, y_train2)
    #plot_decision_tree(clf, X_train2.columns, y_train2.columns)
    print('Mushroom dataset: decision tree')
    print('Accuracy of DT classifier on training set: {:.2f}' .format(clf.score(X_train2, y_train2)))
    print('Accuracy of DT classifier on test set: {:.2f}'.format(clf.score(X_test2, y_test2)))
...
def answer_seven():
    ...
    return 0.0001, 1, 0.1 # Return your answer
